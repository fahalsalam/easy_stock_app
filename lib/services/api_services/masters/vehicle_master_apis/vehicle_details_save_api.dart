...
Future<String> AddVehileDetailsAPI(
    {vehicleName,
    vehicleNumber,
    driverName,
    contactNo,
  ...
  log('post vehicle master ${jsonEncode(data)}');
  try {
    final response =
